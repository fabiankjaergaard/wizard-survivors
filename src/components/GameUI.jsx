...
// Components and constants are loaded from separate files (constants.jsx, BackButton.jsx)
// and are available globally in the browser
    ...
    return (
        <div className="game-ui-container">
            <div id="game-container">
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                {upgrades.map((upgrade, index) => {
                                    // Determine badge colors, glow and particle effects based on rarity
                                    let badgeColor = '#6b7280';
                                    let badgeTextColor = '#ffffff';
                                    let badgeGlow = '0 0 8px rgba(107, 114, 128, 0.6)';
                                    let badgeParticleClass = 'badge-particles-common';
                                    let rarityName = 'common';

                                    // Set badge styling based on rarity
                                    if (upgrade.rarity) {
                                        // Get rarity name and convert to lowercase
                                        rarityName = (upgrade.rarity.name || upgrade.rarity.key || upgrade.rarity || '').toString().toLowerCase();

                                        if (rarityName.includes('common')) {
                                            badgeColor = '#6b7280';
                                            badgeTextColor = '#ffffff';
                                            badgeGlow = '0 0 8px rgba(107, 114, 128, 0.6)';
                                            badgeParticleClass = 'badge-particles-common';
                                        } else if (rarityName.includes('rare')) {
                                            badgeColor = '#2563eb';
                                            badgeTextColor = '#ffffff';
                                            badgeGlow = '0 0 10px rgba(37, 99, 235, 0.8)';
                                            badgeParticleClass = 'badge-particles-rare';
                                        } else if (rarityName.includes('epic')) {
                                            badgeColor = '#9333ea';
                                            badgeTextColor = '#ffffff';
                                            badgeGlow = '0 0 12px rgba(147, 51, 234, 0.9)';
                                            badgeParticleClass = 'badge-particles-epic';
                                        } else if (rarityName.includes('legend')) {
                                            badgeColor = '#ea580c';
                                            badgeTextColor = '#ffffff';
                                            badgeGlow = '0 0 15px rgba(234, 88, 12, 1)';
                                            badgeParticleClass = 'badge-particles-legendary';
                                        }
                                    }
                                    ...
                                    return (
                                        <button
                                            ...
                                            onMouseEnter={(e) => {
                                                ...
                                                e.currentTarget.style.filter = 'brightness(1.2) drop-shadow(0 8px 12px rgba(0,0,0,0.4))';
                                            ...
                                            onMouseUp={(e) => {
                                                e.currentTarget.style.transform = 'translateY(-5px) scale(1.03)';
                                                e.currentTarget.style.filter = 'brightness(1.2) drop-shadow(0 8px 12px rgba(0,0,0,0.4))';
                                                e.currentTarget.style.transition = 'all 0.15s cubic-bezier(0.34, 1.56, 0.64, 1)';
                                            }}
                                        >
                                                    ...
                                                    <div style={{
                                                        ...
                                                        {upgrade.rarity && (
                                                            <span
                                                                ...
                                                                {upgrade.rarity.name}
                                                                {/* Orbiting particles - only on Epic and Legendary */}
                                                                {rarityName.includes('epic') && (
                                                                    <>
                                                                        <span style={{
                                                                            position: 'absolute',
                                                                            width: '4px',
                                                                            ...
                                                                            boxShadow: `0 0 8px ${badgeColor}, 0 0 12px ${badgeColor}`,
                                                                            left: '50%',
                                                                            top: '50%',
                                                                            marginLeft: '-2px',
                                                                            marginTop: '-2px',
                                                                            animation: `orbit-badge-${index % 3}-1 2s linear infinite`,
                                                                            pointerEvents: 'none',
                                                                            opacity: 0.9
                                                                        }}></span>
                                                                        <span style={{
                                                                            ...
                                                                            borderRadius: '50%',
                                                                            background: `radial-gradient(circle, ${badgeColor}, transparent)`,
                                                                            boxShadow: `0 0 7px ${badgeColor}, 0 0 10px ${badgeColor}`,
                                                                            left: '50%',
                                                                            top: '50%',
                                                                            marginLeft: '-1.5px',
                                                                            marginTop: '-1.5px',
                                                                            animation: `orbit-badge-${index % 3}-2 2.5s linear infinite`,
                                                                            pointerEvents: 'none',
                                                                            opacity: 0.85
                                                                        }}></span>
                                                                        <span style={{
                                                                            ...
                                                                            borderRadius: '50%',
                                                                            background: `radial-gradient(circle, ${badgeColor}, transparent)`,
                                                                            boxShadow: `0 0 6px ${badgeColor}, 0 0 9px ${badgeColor}`,
                                                                            left: '50%',
                                                                            top: '50%',
                                                                            marginLeft: '-1.5px',
                                                                            marginTop: '-1.5px',
                                                                            animation: `orbit-badge-${index % 3}-3 2.3s linear infinite 0.5s`,
                                                                            pointerEvents: 'none',
                                                                            opacity: 0.8
                                                                        }}></span>
                                                                    </>
                                                                ...
                                                                {rarityName.includes('legend') && (
                                                                    <>
                                                                        <span style={{
                                                                            ...
                                                                            borderRadius: '50%',
                                                                            background: `radial-gradient(circle, ${badgeColor}, transparent)`,
                                                                            boxShadow: `0 0 12px ${badgeColor}, 0 0 18px ${badgeColor}, 0 0 24px ${badgeColor}`,
                                                                            left: '50%',
                                                                            top: '50%',
                                                                            marginLeft: '-3px',
                                                                            marginTop: '-3px',
                                                                            animation: `orbit-badge-${index % 3}-1 1.2s linear infinite`,
                                                                            pointerEvents: 'none',
                                                                            opacity: 1
                                                                        }}></span>
                                                                        <span style={{
                                                                            ...
                                                                            borderRadius: '50%',
                                                                            background: `radial-gradient(circle, ${badgeColor}, transparent)`,
                                                                            boxShadow: `0 0 10px ${badgeColor}, 0 0 15px ${badgeColor}, 0 0 20px ${badgeColor}`,
                                                                            left: '50%',
                                                                            top: '50%',
                                                                            marginLeft: '-2.5px',
                                                                            marginTop: '-2.5px',
                                                                            animation: `orbit-badge-${index % 3}-2 1.5s linear infinite`,
                                                                            pointerEvents: 'none',
                                                                            opacity: 0.95
                                                                        }}></span>
                                                                        <span style={{
                                                                            ...
                                                                            borderRadius: '50%',
                                                                            background: `radial-gradient(circle, ${badgeColor}, transparent)`,
                                                                            boxShadow: `0 0 9px ${badgeColor}, 0 0 14px ${badgeColor}, 0 0 18px ${badgeColor}`,
                                                                            left: '50%',
                                                                            top: '50%',
                                                                            marginLeft: '-2.5px',
                                                                            marginTop: '-2.5px',
                                                                            animation: `orbit-badge-${index % 3}-3 1.4s linear infinite 0.3s`,
                                                                            pointerEvents: 'none',
                                                                            opacity: 0.92
                                                                        }}></span>
                                                                        <span style={{
                                                                            ...
                                                                            marginLeft: '-2px',
                                                                            marginTop: '-2px',
                                                                            animation: `orbit-badge-${index % 3}-1 1.8s linear infinite 0.6s`,
                                                                            pointerEvents: 'none',
                                                                            opacity: 0.88
                                                                        }}></span>
                                                                    </>
                ...
                {showPaused && !showLevelUp && !showGameOver && !showChestPopup && !showMysteryBoxSpinner && !showMusicControl && (
                    <div className="modal-overlay">
                        <div style={{
                            position: 'relative',
                            width: 'min(500px, 90vw)',
        ...
        <div style={{
            ...
            {skillTrees.map((tree, treeIndex) => (
                <div key={treeIndex} className="main-menu-box" style={{
                    ...
                    {/* Tree Badge Icon - overlapping top */}
                    <img
                        src={`assets/SkillTree${tree.name === 'Combat' ? 'Combat' : tree.name === 'Defense' ? 'DefenseGame' : 'MagicGame'}.png`}
                        alt={tree.name}
                        style={{
                            position: 'absolute',
                            top: '10px',
